        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModelEntity = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_DataUser_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Message_DataUser_SenderId",
                        column: x => x.SenderId,
                        principalTable: "DataUser",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataUserGroup", x => new { x.GroupsId, x.MembersId });
                    table.ForeignKey(
                        name: "FK_DataUserGroup_DataUser_MembersId",
                        column: x => x.MembersId,
                        principalTable: "DataUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DataUserGroup_Group_GroupsId",
                        column: x => x.GroupsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SystemTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contact_DataUser_UserId",
                        column: x => x.UserId,
                        principalTable: "DataUser",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Contact_SystemType_SystemTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataUserGroup_MembersId",
                table: "DataUserGroup",
                column: "MembersId");
